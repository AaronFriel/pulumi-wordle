...
namespace Pulumi.Wordle
{
    static class Utilities
    {
        ...
        public static InvokeOptions WithDefaults(this InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/aaronfriel/pulumi-wordle/releases/download/v${VERSION}";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Wordle.version.txt");
    ...
    internal sealed class WordleResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public WordleResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
